...
class HomepagesControllerTest < ActionController::TestCase
  ...
  test "should create homepage" do
    assert_difference('Homepage.count') do
      post :create, homepage: { description: @homepage.description, title: @homepage.title }
    end
  ...
  test "should update homepage" do
    patch :update, id: @homepage, homepage: { description: @homepage.description, title: @homepage.title }
    assert_redirected_to homepage_path(assigns(:homepage))
  end
